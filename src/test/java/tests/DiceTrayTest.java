...
public class DiceTrayTest {
	...
	private DiceTray randBrd1, lngWrdBrd, repeatsBrd, randomBrd;
	...
	public void wordsLessThan3() {
		...
		// randBrd1, "DEBT"));
		assertFalse("Could not find 'L' in" + randBrd1String, searchBoard(randBrd1, "L"));
		assertFalse("Could not find 'LO' in" + randBrd1String, searchBoard(randBrd1, "LO"));
		assertFalse("Could not find '' in" + randBrd1String, searchBoard(randBrd1, ""));
